...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.45) Muertes Maternas según Realización de Necropsia','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Realización de Necropsia</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Necropsia</th>
