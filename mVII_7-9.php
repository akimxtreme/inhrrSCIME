...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.9) Muertes maternas según cantidad de hijos huérfanos','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes maternas según cantidad de hijos huérfanos</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">N° de hijos huérfanos</th>
