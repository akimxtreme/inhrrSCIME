...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.38) Muertes Maternas según Momento del Aborto','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Momento del Aborto</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Periodo del Aborto</th>
        ...
        <tr class="text-center">
            <td>Durante el aborto</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Post-aborto (Hasta 24 horas)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
        ...
        <tr class="text-center">
            <td>Post-aborto (7 y más días)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
