...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.5) Muertes Maternas según causas, cifras absolutas  y porcentajes','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según causas, cifras absolutas  y porcentajes</h6>
    </div>
    <table class="large-12">
        ...
        <tr>
            ...
            <th class="text-center">Causas Obstétricas Directas</th>
            <th class="text-center">Porcentaje (%)</th>
            <th class="text-center">Causas Obstétricas Indirectas</th>
            <th class="text-center">Porcentaje (%)</th>
        </tr>
        </thead>
        <tbody>
