...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(5.10) Personal  médico, de  enfermería y obreros. Servicios de obstetricia de hospitales y maternidades. Estado XXXX. Año XXXX','V. Datos sobre Respuesta Social a la Población Materna');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Personal  médico, de  enfermería y obreros. Servicios de obstetricia de hospitales y maternidades. Estado XXXX. Año XXXX</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center" rowspan="2">Hospitales y Maternidades</th>
            <th class="text-center" colspan="4">Personal Médico</th>
            <th class="text-center" rowspan="2">Personal de Enfermería</th>
        ...
        <tr>
            ...
            <th class="text-center" colspan="">Personal obrero</th>
        </tr>
        </thead>
        <tbody>
