...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.47) Muertes Maternas según Limitaciones en Demora 1','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Limitaciones en Demora 1</h6>
    </div>
    <table class="large-12">
        ...
        <tr class="text-center">
            <td>Desconocimiento de signos de Alarma</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Rehúsa atención médica</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
