...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.35) Muertes Maternas según Periodo de Ocurrencia  del Fallecimiento','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Periodo de Ocurrencia  del Fallecimiento</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Periodo Ocurrencia  del Fallecimiento</th>
