...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.32) Muertes Maternas según Terminación del Embarazo','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Terminación del Embarazo</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Terminación del Embarazo</th>
