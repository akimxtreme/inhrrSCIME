...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.12) Muertes Maternas según Nivel de Instrucción','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Nivel de Instrucción</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Nivel de Instrucción</th>
