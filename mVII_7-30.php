...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.30) Muertes Maternas según Tipo de Embarazo','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Tipo de Embarazo</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Tipo de embarazo</th>
