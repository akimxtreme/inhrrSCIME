...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.22) Muertes Maternas según N° de Mortinatos  Anteriores','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según N° de Mortinatos  Anteriores</h6>
    </div>
