...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.34) Muertes Maternas según Edad Gestacional','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Edad Gestacional</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Edad Gestacional</th>
