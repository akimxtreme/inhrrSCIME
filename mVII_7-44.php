...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.44) Muertes Maternas según Presencia de Infección Hospitalaria','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Tiempo Transcurrido entre la Admisión y la Defunción de la Madre</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Presencia de Infección Hospitalaria</th>
