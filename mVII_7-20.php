...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.20) Muertes Maternas según N° de Cesáreas Anteriores','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según N° de Cesáreas Anteriores</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">N° de Cesáreas Anteriores</th>
