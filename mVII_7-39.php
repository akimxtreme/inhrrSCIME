...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.39) Muertes Maternas según Momento del Curetaje','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Momento del Curetaje</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Periodo del Curetaje</th>
        ...
        <tr class="text-center">
            <td>Durante el curetaje</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Post-curetaje (Hasta 24 horas)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Post-aborto (2-6 días)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Post-curetaje (2-6 días)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Post-curetaje (7 y más días)</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
