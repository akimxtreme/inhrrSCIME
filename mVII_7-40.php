...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.40) Muertes Maternas según Referencia','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Referencia</h6>
    </div>
