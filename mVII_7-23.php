...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.23) Muertes Maternas según Intervalo Intergenésico','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Intervalo Intergenésico</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">N° de Mortinatos  Anteriores</th>
