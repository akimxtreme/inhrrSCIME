...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.15) Muertes Maternas según Condición de la Pareja','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Condición de la Pareja</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Condición de la Pareja</th>
