...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.48) Muertes Maternas según Problemas en Demora 2','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Problemas en Demora 2</h6>
    </div>
    <table class="large-12">
        ...
        <tr class="text-center">
            <td>Domicilio lejano</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Faltó dinero para movilización</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Faltó transporte</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Vía en malas condiciones</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
