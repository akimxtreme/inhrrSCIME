...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.29) Muertes Maternas según Necesidad de Consulta de Alto Riesgo','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Necesidad de Consulta de Alto Riesgo</h6>
    </div>
