...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.19) Muertes Maternas según N° Partos Vaginales Anteriores','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según N° Partos Vaginales Anteriores</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">N° partos Vaginales Anteriores</th>
