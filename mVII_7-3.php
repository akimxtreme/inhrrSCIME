...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.3) Mortalidad Materna según clasificación, número y porcentaje','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Mortalidad Materna según clasificación, número y porcentaje</h6>
    </div>
