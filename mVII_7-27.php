...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.27) Muertes Maternas según Semanas de Gestación al Inicio del Control Prenatal','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Semanas de Gestación al Inicio del Control Prenatal</h6>
    </div>
    <table class="large-12">
        <thead>
        <tr>
            <th class="text-center">Semanas de Gestación al Inicio del Control Prenatal</th>
