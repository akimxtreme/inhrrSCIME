...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(7.49) Muertes Maternas según Limitaciones en Demora 3','VII. Cuadros Sobre Caracterización de Muertes Maternas');
    ?>
    <div class="row">
    <h6 class="text-center large-12 columns">Muertes Maternas según Limitaciones en Demora 3</h6>
    </div>
    <table class="large-12">
        ...
        <tr class="text-center">
            <td>Indicaron tratamiento ambulatorio</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Establecimiento sin cupo</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Demora en el traslado por falta de ambulancia para traslado</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Demora en el traslado por ambulancia no disponible en el momento</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Demora en el traslado por falta de gasolina para la ambulancia</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
            <td>Demora en el traslado por otras causas</td>
            <td>0</td>
            <td>0,00 %</td>
        </tr>
        <tr class="text-center">
