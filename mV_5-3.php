...
echo '<div class="row">';
    ...
    $titulo = new Titulo('(5.3) Unidades de Cuidados intensivos. Número por adscripción según municipio. Estado XXXX. Año XXXX','V. Datos sobre Respuesta Social a la Población Materna');
    ?>
    <div class="row">
